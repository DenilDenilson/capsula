        ...
        <ul className="py-16 bg-secondary">
          <li className="grid grid-cols-[1fr,_64px] gap-4 px-4">
            ...
            {/* Se coloca un texto en el div para que el width haga efecto y se pone del mismo color del fondo para que desaaprezca */}
              <p className="absolute w-3/4 h-full bg-primary-500 left-0 top-0 text-primary-500">.</p>
              <span className="absolute inset-0 grid place-content-center">Introducción a FPGA</span>
            </div>
            <span className="text-gray-100 font-semibold text-sm self-center">clase 10/15</span>
          </li>
        </ul>
      </div>
    </section>
